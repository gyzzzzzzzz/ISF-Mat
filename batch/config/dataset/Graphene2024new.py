# dataset settings
num_batch = 5  # [1,2,3,4]
classes_name = ['background', '1-Layer','2-Layer','3-Layer','4-Layer']
...
data_root = '/home/guyizhan/datasets/fscil_data/2024/Graphene'   
train_dataset = dict(type=dataset_type, data_root=data_root, pipeline=train_pipeline,
                     data_prefix=dict(img_path='NewFolder/images', seg_map_path='NewFolder/annotations'),
                     img_suffix='.jpg', seg_map_suffix='.png', reduce_zero_label=None,
                     classes_name=classes_name)
train_dst_noaug = dict(type=dataset_type, data_root=data_root, pipeline=test_pipeline,
                     data_prefix=dict(img_path='NewFolder/images', seg_map_path='NewFolder/annotations'),
                     img_suffix='.jpg', seg_map_suffix='.png', reduce_zero_label=None,
                     classes_name=classes_name)
